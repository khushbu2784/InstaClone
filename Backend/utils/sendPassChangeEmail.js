...
export const sendPassChangeEmail = async (user) => {
  const html = `
    <div style="font-family: Arial, sans-serif; padding: 24px; max-width: 600px; margin: auto; background-color: #fafafa;">
      ...
      <a href="https://your-app-url.com/forgotPassword" style="margin-top: 20px; display: inline-block; background: #dc2626; color: #fff; padding: 10px 16px; text-decoration: none; border-radius: 6px;">Reset Password</a>
