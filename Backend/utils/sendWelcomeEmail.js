...
export const sendWelcomeEmail = async (user) => {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; padding: 24px; max-width: 600px; margin: auto; background-color: #fafafa;">
      ...
      <a href="${frontendUrl}" style="margin-top: 20px; display: inline-block; background: #3b82f6; color: #fff; padding: 10px 16px; text-decoration: none; border-radius: 6px;">Go to InstaClone</a>
